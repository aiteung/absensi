...
func MessagePulangKerjaCepat(karyawan Karyawan, aktifjamkerja time.Duration, id interface{}, lokasi string, selisihpulang string, Info *types.MessageInfo, whatsapp *whatsmeow.Client) {
	msg := "*Pulang Kerja*\n"
